...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Location = System::Drawing::Point(319, 26);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(159, 20);
			this->label3->TabIndex = 13;
			this->label3->Text = L"Register to system";
			// 
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(174, 129);
			...
			this->label1->Location = System::Drawing::Point(67, 93);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(356, 304);
			...
			this->label5->Location = System::Drawing::Point(67, 169);
			...
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(174, 241);
			...
			this->label7->Location = System::Drawing::Point(67, 244);
			...
			// textBox7
			// 
			this->textBox7->Location = System::Drawing::Point(567, 129);
			...
			this->label8->Location = System::Drawing::Point(416, 93);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(102, 13);
			this->label8->TabIndex = 22;
			this->label8->Text = L"Security Question1 :";
			// 
			// label9
			// 
			this->label9->AutoSize = true;
			this->label9->Location = System::Drawing::Point(416, 192);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(102, 13);
			this->label9->TabIndex = 26;
			this->label9->Text = L"Security Question2 :";
			// 
			// label10
			// 
			this->label10->AutoSize = true;
			this->label10->Location = System::Drawing::Point(416, 129);
			this->label10->Name = L"label10";
			this->label10->Size = System::Drawing::Size(140, 13);
			this->label10->TabIndex = 27;
			this->label10->Text = L"What\'s your birth city name\?";
			// 
			// label11
			// 
			this->label11->AutoSize = true;
			this->label11->Location = System::Drawing::Point(416, 223);
			this->label11->Name = L"label11";
			this->label11->Size = System::Drawing::Size(145, 13);
			this->label11->TabIndex = 29;
			this->label11->Text = L"What\'s your first contact no.\?";
			// 
			// textBox8
			// 
			this->textBox8->Location = System::Drawing::Point(567, 223);
			...
			this->comboBox1->Location = System::Drawing::Point(174, 203);
			...
			this->label6->Location = System::Drawing::Point(67, 206);
			...
			this->ClientSize = System::Drawing::Size(781, 412);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		try
		{
			...
			String^ SecurityQ1 = textBox7->Text;
			String^ SecurityQ2 = textBox8->Text;
