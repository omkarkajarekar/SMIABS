...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(109, 58);
			...
			this->label1->Location = System::Drawing::Point(42, 61);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(354, 56);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(739, 21);
